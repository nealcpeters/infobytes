...
Tutorial.create(title: "How to Be Matt", description: "A detailed tutorial on how to be the most gnarly land lubber of a freight train", user_id: 1, rating: 3, subtopic_id: 1)
tutorial = Tutorial.create(title: "How to Be Neal", description: "A detailed tutorial on how to be the most gnarly land lubber of a sailor", user_id: 1, rating: 3, subtopic_id: 1)
